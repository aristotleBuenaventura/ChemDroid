...
class Q9Activity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants9.getQuestions()
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants9.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants9.totalQuestion, mQuestionsList!!.size)
