...
class Q3Activity : AppCompatActivity(), View.OnClickListener  {
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants3.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants3.totalQuestion, mQuestionsList!!.size)
