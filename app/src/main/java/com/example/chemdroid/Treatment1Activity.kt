...
import kotlinx.android.synthetic.main.activity_treatment1.*

class Treatment1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        card_15.cameraDistance = 8000 * scale
        card_16.cameraDistance = 8000 * scale

        card_17.cameraDistance = 8000 * scale
        card_18.cameraDistance = 8000 * scale
                            ...
                            flip_bt5.setOnClickListener {
                                ...
                                flip_bt6.setOnClickListener {
                                    ...
                                    flip_bt7.setOnClickListener {
                                        ...
                                        flip_bt8.setOnClickListener {
                                            if (isFront) {
                                                front_anim.setTarget(card_15)
                                                back_anim.setTarget(card_16)
                                                front_anim.start()
                                                back_anim.start()
                                                isFront = false
                                            } else {
                                                front_anim.setTarget(card_16)
                                                back_anim.setTarget(card_15)
                                                back_anim.start()
                                                front_anim.start()
                                                isFront = true
                                            ...
                                            flip_bt9.setOnClickListener {
                                                if (isFront) {
                                                    front_anim.setTarget(card_17)
                                                    back_anim.setTarget(card_18)
                                                    front_anim.start()
                                                    back_anim.start()
                                                    isFront = false
                                                } else {
                                                    front_anim.setTarget(card_18)
                                                    back_anim.setTarget(card_17)
                                                    back_anim.start()
                                                    front_anim.start()
                                                    isFront = true
