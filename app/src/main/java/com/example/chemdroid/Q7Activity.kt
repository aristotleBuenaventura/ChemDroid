...
class Q7Activity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants7.getQuestions()
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants7.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants7.totalQuestion, mQuestionsList!!.size)
