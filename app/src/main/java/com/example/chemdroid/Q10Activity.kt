...
class Q10Activity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants10.getQuestions()
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants10.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants10.totalQuestion, mQuestionsList!!.size)
