...
class Q5Activity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants5.getQuestions()
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants5.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants5.totalQuestion, mQuestionsList!!.size)
