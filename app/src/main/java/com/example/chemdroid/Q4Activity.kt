...
class Q4Activity : AppCompatActivity(), View.OnClickListener  {
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants4.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants4.totalQuestion, mQuestionsList!!.size)
