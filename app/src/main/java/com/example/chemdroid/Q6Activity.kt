...
class Q6Activity : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constants6.getQuestions()
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants6.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants6.totalQuestion, mQuestionsList!!.size)
