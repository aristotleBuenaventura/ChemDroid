...
class Q2Activity : AppCompatActivity(),View.OnClickListener {
            ...
            R.id.buttonSubmit -> {
                if(mSelectedOptionPosition == 0) {
                    ...
                    when{
                        ...
                        intent.putExtra(Constants2.correctAnswer, mCorrectAnswer)
                        intent.putExtra(Constants2.totalQuestion, mQuestionsList!!.size)
